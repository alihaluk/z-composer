...
export const GLOBAL_DATA_SOURCES: DataSource[] = [
    ...
    { id: 'Tenant.Name', name: 'Tenant Name', mockValue: 'SAMPLE TENANT INC.' },
    { id: 'Tenant.Address', name: 'Tenant Address', mockValue: '123 SAMPLE STREET, SAMPLE CITY, 34000' },
    { id: 'Tenant.TaxOffice', name: 'Tenant Tax Office', mockValue: 'SAMPLE TAX OFFICE' },
    { id: 'Tenant.TaxNumber', name: 'Tenant Tax Number', mockValue: '1111111111' },
    { id: 'Tenant.Phone', name: 'Tenant Phone', mockValue: '(555) 123-45-67' },
